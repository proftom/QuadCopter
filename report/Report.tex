...
%todo: rewrite this section, will do shortly (Ryan)
...
Mavrx is a small start-up firm that is aiming to provide autonomous aerial imaging hardware and software for commercial enterprise. Additionally, Mavrx has a daughter firm, UAir, that targets the hobbyist market and which recently succeeded in crowd-funding a cheap quadcopter development platform. They have asked us to help pave the road to a fully autonomous flying platform that will be priced in the consumer range rather than the military/commercial category of existing platforms. 
...
The approaches to localisation for \ac{UAV}s and \ac{MAV}s fall into three main categories: Optical flow tracking \cite{DBLP:conf/icra/GrabeBG12}, \ac{ToF} laser scanners \cite{Bry2012} and \ac{RGB-D} cameras \cite{Shen2012}.
