...
\begin{align}
	D_y &= \frac{\partial d}{\partial y} \notag \\
		&= T_d \\
	D_x &= \frac{\partial d}{\partial x} \notag \\
		&=
	\left[
	\begin{matrix}
		\begin{matrix}
...
\begin{align}
	...
	\left[
	\begin{matrix}
		D_{Nq1} 	& -D_{Nq0} 	& D_{Nq3} 	& -D_{Nq2} \\
		D_{Nq2} 	& -D_{Nq3} 	& -D_{Nq0} 	& D_{Nq1} \\
		D_{Nq3} 	& D_{Nq2} 	& -D_{Nq1} 	& -D_{Nq0}
	\end{matrix}
	\right]
\end{align}
where
\begin{align}
	D_{Nq(0\cdots3)} &= \Xi(q) \hat{N}
\end{align}
