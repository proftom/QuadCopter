...
\begin{figure}[htb]
	...
	\end{center}
	\caption{A MATLAB plot showing a plane as viewed from above. Actual distance to plane is 5m}
	\label{fig:uncal5m}
\end{figure}
...
% section sensor_calibration (end)
=======
...
$f$ operates in discrete time, but we have established our model in continous time. As such, we perform a first order approximation to the continous time system:
