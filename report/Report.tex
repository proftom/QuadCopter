...
To obtain consistent and robust computer vision the open source \ac{PCL} was used as a foundation on which our vision algorithms were implemented. By levering the both well featured and documented \ac{PCL} allowed us to rapidly develop and test our algorithms in real time. 
...
\\|\abs{P_{seed|D} - P_{D}}| &< (|\abs{N_{seed|z} \times P^{2}_{seed|z}}| + |\abs{N_{z} \times P^{2}_{z}}|) \times \epsilon_{depth}
\end{align}
