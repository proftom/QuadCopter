...
As mentioned above, the factory calibration of the RGB-D camera's depth sensor is unsatisfactory for the target application. Straight walls as seen by the sensor at distances of more than 2m quickly become warped (see Figure~\ref{fig:matlabuncal5m}). Such depth data quality would make feature extraction infeasible at distances of interest.

\begin{figure}[H]
\centering     %%% not \center
\subfloat[xyz space point cloud]{\label{fig:matlabuncal5m}\includegraphics[width=0.8\textwidth]{uncal5m.PNG}} \;
%\subfloat[coloured point cloud]{\label{fig:clouduncal5m}\includegraphics[width=60mm]{wallat6m}}
\caption{Example of the poor factory calibration of the Xtion sensor when looking at a wall 4 meters from the camera}
\label{fig:uncal5m}
\end{figure}
