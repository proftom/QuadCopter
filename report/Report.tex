...
\begin{figure}[tbp]
	...
	\subfloat[\ac{DBScan} in normal space. A total of 4 planes were found: The floor, the white boards and two back walls] 
	{
		...
		\includegraphics[width=0.5\textwidth]{6normal_boards.png}
	}
	\subfloat[\ac{DBScan} of the laboratory in xyz space. Each white board is considered a separate cluster. Distant objects coloured in blue.] {
		\label{fig:table_dbscan}
		\includegraphics[width=0.5\textwidth]{6table_dbscan.png}
	}
	\caption{Images}
