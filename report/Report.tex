...
\begin{align}
	...
	\right]
\end{align}
To update the P or state covariance matrix, we have to compute the jacobian of e w.r.t the state denoted as $E_x$ and the jacobiain w.r.t the newly observed plane denoted as $E_y$.
\begin{align}
