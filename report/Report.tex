...
The forward observation model $h$, as required by Equation~(\ref{eqn:measurement_model}), is derived below. This function defines the measurement as a function of the state. That is, using this function we can compute the expected plane measurement given our current state estimate.
\begin{align}
	T_h &= 
	\left[
	\begin{matrix}
