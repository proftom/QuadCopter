...
\begin{figure}[p]
	\centering     %%% not \center
	\subfloat[Box before applying Flood Fill algorithm]{
		\label{fig:6box_before}
		\includegraphics[width=0.4\textwidth]{6box_before.PNG}
	}
	\;
	\subfloat[Box after applying Flood Fill algorithm]{
		\label{fig:6box_after}
		\includegraphics[width=0.4\textwidth]{6box_afterward.PNG}
	}

	\caption{Plane finding using Flood Fill $\epsilon=0.2, \gamma=50, \sigma=0.8$}
